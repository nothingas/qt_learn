...
namespace {
struct qt_meta_tag_ZN11TDiceThreadE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN11TDiceThreadE = QtMocHelpers::stringData(
    "TDiceThread",
    "newValue",
    "",
    "seq",
...
Q_CONSTINIT static const uint qt_meta_data_ZN11TDiceThreadE[] = {
...
Q_CONSTINIT const QMetaObject TDiceThread::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN11TDiceThreadE.offsetsAndSizes,
    qt_meta_data_ZN11TDiceThreadE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN11TDiceThreadE_t,
        // Q_OBJECT / Q_GADGET
...
void TDiceThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (TDiceThread::*)(int , int );
            if (_q_method_type _q_method = &TDiceThread::newValue; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *TDiceThread::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN11TDiceThreadE.stringdata0))
