...
public:
    ...
    void setupUi(QDialog *TPenDialog)
    {
        ...
        QBrush brush1(QColor(53, 132, 228, 255));
        brush1.setStyle(Qt::SolidPattern);
        palette.setBrush(QPalette::Active, QPalette::Button, brush1);
        QBrush brush2(QColor(146, 195, 255, 255));
        brush2.setStyle(Qt::SolidPattern);
        palette.setBrush(QPalette::Active, QPalette::Light, brush2);
        QBrush brush3(QColor(99, 163, 241, 255));
        brush3.setStyle(Qt::SolidPattern);
        palette.setBrush(QPalette::Active, QPalette::Midlight, brush3);
        QBrush brush4(QColor(26, 66, 114, 255));
        brush4.setStyle(Qt::SolidPattern);
        palette.setBrush(QPalette::Active, QPalette::Dark, brush4);
        QBrush brush5(QColor(35, 88, 152, 255));
        ...
        QBrush brush7(QColor(154, 193, 241, 255));
        ...
        QBrush brush10(QColor(26, 66, 114, 127));
        brush10.setStyle(Qt::SolidPattern);
#if QT_VERSION >= QT_VERSION_CHECK(5, 12, 0)
        palette.setBrush(QPalette::Disabled, QPalette::PlaceholderText, brush10);
#endif
        QBrush brush11(QColor(101, 170, 255, 255));
        ...
        buttonBox = new QDialogButtonBox(TPenDialog);
    ...
    void retranslateUi(QDialog *TPenDialog)
    {
        ...
        groupBox->setTitle(QCoreApplication::translate("TPenDialog", "QPen_Setting", nullptr));
        label->setText(QCoreApplication::translate("TPenDialog", "LineType", nullptr));
        label_2->setText(QCoreApplication::translate("TPenDialog", "LineWidth", nullptr));
        label_3->setText(QCoreApplication::translate("TPenDialog", "LineColor", nullptr));
        pushButton->setText(QCoreApplication::translate("TPenDialog", "PushButton", nullptr));
    } // retranslateUi
